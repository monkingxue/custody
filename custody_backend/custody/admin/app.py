...
from custody.admin.views import HomeView
...
from custody.admin import (
    customer,
    coin
)
from custody import models
...
def register_admin(app):
    admin.add_view(customer.views.CustomerAdminView())
    admin.add_view(coin.views.CoinAdminView())
    admin.add_view(coin.views.CoinFavoriteAdminView())
    return None
